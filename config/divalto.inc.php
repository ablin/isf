...
define('_DV_LAYERED_FEATURE_ALWAYS_DISPLAYED_', array("Marque" => 463, "Famille" => 22, "Sous-famille" => 23));
...
/* Features to use for retrieve parent image */
define('_DV_FEATURE_LEVEL_2_IMAGE_', 23);
