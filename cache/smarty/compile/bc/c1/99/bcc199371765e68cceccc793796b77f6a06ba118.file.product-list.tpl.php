<?php /* Smarty version Smarty-3.1.19, created on 2017-03-28 15:16:16
         compiled from "/var/www/html/prestashop/themes/default-bootstrap/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:173667713458d6a0f6a58f72-48166113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '173667713458d6a0f6a58f72-48166113',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_58d6a0f6ae94c7_22064143',
  'variables' => 
  array (
    'products' => 0,
    'page_name' => 0,
...
<?php if ($_valid && !is_callable('content_58d6a0f6ae94c7_22064143')) {function content_58d6a0f6ae94c7_22064143($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/prestashop/tools/smarty/plugins/function.math.php';
?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <p class="product-reference" itemprop="reference">
                        ...
                        <?php echo strip_tags($_smarty_tpl->tpl_vars['product']->value['reference']);?>

                    </p>
                    <p class="product-manufacturer" itemprop="reference">
                        <label><?php echo smartyTranslate(array('s'=>'Manufacturer:'),$_smarty_tpl);?>
</label>
                        <?php echo strip_tags($_smarty_tpl->tpl_vars['product']->value['manufacturer_name']);?>
                    ...
                    <p class="product-stock" itemprop="stock">
                        ...
                        <span class="availability">
                            <?php if ($_smarty_tpl->tpl_vars['references']->value[$_smarty_tpl->tpl_vars['product']->value['reference']]['stock']>0) {?>
                                <span class="label-success">
                                    <?php echo $_smarty_tpl->tpl_vars['references']->value[$_smarty_tpl->tpl_vars['product']->value['reference']]['stock'];?>
					...
					<div class="content_price">
						<span class="price product-price">
                            <?php if (count($_smarty_tpl->tpl_vars['references']->value[$_smarty_tpl->tpl_vars['product']->value['reference']]['tarif'])>0&&$_smarty_tpl->tpl_vars['references']->value[$_smarty_tpl->tpl_vars['product']->value['reference']]['tarif'][0]->pun>0) {?>
                                <?php echo smartyTranslate(array('s'=>'From:'),$_smarty_tpl);?>

                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['references']->value[$_smarty_tpl->tpl_vars['product']->value['reference']]['tarif'][0]->pun),$_smarty_tpl);?>

                            <?php } else { ?>
                                <?php echo smartyTranslate(array('s'=>'Price on demand'),$_smarty_tpl);?>
