<?php /* Smarty version Smarty-3.1.19, created on 2017-03-25 18:05:06
         compiled from "/var/www/html/prestashop/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:190702036058d6a342932d24-79636525%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd23539f40c36e1c9271fe9077c7f6bb29206a9e3' => 
    array (
      0 => '/var/www/html/prestashop/themes/default-bootstrap/product.tpl',
      1 => 1490457235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '190702036058d6a342932d24-79636525',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d6a342a6c315_71313662',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d6a342a6c315_71313662')) {function content_58d6a342a6c315_71313662($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/prestashop/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/html/prestashop/tools/smarty/plugins/function.cycle.php';
...
<?php }?></span>
                ...
                <p id="product_manufacturer_name"<?php if (empty($_smarty_tpl->tpl_vars['product']->value->manufacturer_name)||!$_smarty_tpl->tpl_vars['product']->value->manufacturer_name) {?> style="display: none;"<?php }?>>
                    <label><?php echo smartyTranslate(array('s'=>'Manufacturer:'),$_smarty_tpl);?>
 </label>
                    <span class="editable" itemprop="sku"<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->manufacturer_name)&&$_smarty_tpl->tpl_vars['product']->value->manufacturer_name) {?> content="<?php echo $_smarty_tpl->tpl_vars['product']->value->manufacturer_name;?>
"<?php }?>><?php if (!isset($_smarty_tpl->tpl_vars['groups']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true);?>
<?php }?></span>
                </p>
                ...
                <p id="availability_statut">
                    <label><?php echo smartyTranslate(array('s'=>'Stock:'),$_smarty_tpl);?>
</label>
                ...
                <?php if (count($_smarty_tpl->tpl_vars['tarif']->value[0])==0||$_smarty_tpl->tpl_vars['tarif']->value[0]->pun==0) {?>
                    <p id="price_on_demand">
                        <span class="label label-warning"><?php echo smartyTranslate(array('s'=>'Price on demand'),$_smarty_tpl);?>
</span>
                    </p>
                <?php }?>
...
<?php }?>
            ...
            <?php if (count($_smarty_tpl->tpl_vars['tarif']->value)>0&&$_smarty_tpl->tpl_vars['tarif']->value[0]->pun>0) {?>
                <div class="col-sm-7">
                    <table id="productTarifs">
                        <tr>
                            <th><?php echo smartyTranslate(array('s'=>'Minimal quantity'),$_smarty_tpl);?>
</th>
                            <th><?php echo smartyTranslate(array('s'=>'Unit price'),$_smarty_tpl);?>
</th>
                            <th><?php echo smartyTranslate(array('s'=>'Discount'),$_smarty_tpl);?>
</th>
                            <th><?php echo smartyTranslate(array('s'=>'Net price'),$_smarty_tpl);?>
</th>
                        </tr>
                        <?php  $_smarty_tpl->tpl_vars['line'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['line']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['tarif']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['line']->key => $_smarty_tpl->tpl_vars['line']->value) {
$_smarty_tpl->tpl_vars['line']->_loop = true;
?>
                            <tr>
                                <td><?php echo $_smarty_tpl->tpl_vars['line']->value->qte;?>
</li>
                                <td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['line']->value->pub),$_smarty_tpl);?>
</li>
                                <td><?php echo $_smarty_tpl->tpl_vars['line']->value->remise;?>
</li>
                                <td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['line']->value->pun),$_smarty_tpl);?>
</li>
                            <tr>
                        <?php } ?>
                    </table>
					...
					<div class="box-cart-bottom">
						<div>
							<p id="add_to_cart" class="buttons_bottom_block no-print">
								<button type="submit" name="Submit" class="exclusive" <?php if (count($_smarty_tpl->tpl_vars['tarif']->value)==0||$_smarty_tpl->tpl_vars['tarif']->value[0]->pun==0||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> disabled<?php }?>>
