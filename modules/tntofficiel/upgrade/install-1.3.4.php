 ...
 */
function upgrade_module_1_3_4($objArgTNTOfficiel_1_3_4)
{
    // New Hook.
    if (!$objArgTNTOfficiel_1_3_4->registerHook('actionGetExtraMailTemplateVars')) {
        return false;
    }

    // Module::uninstall().
    if (!$objArgTNTOfficiel_1_3_4->uninstall()) {
        return false;
    }
    ...
    // Module::install().
    if (!$objArgTNTOfficiel_1_3_4->install()) {
        return false;
    }
