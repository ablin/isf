...
function upgrade_module_1_2_22($objArgTNTOfficiel_1_2_22)
{
    ...
    $strModuleDirSrc = $objArgTNTOfficiel_1_2_22->getLocalPath();
    ...
    if (!($objArgTNTOfficiel_1_2_22->uninstallOverrides() && $objArgTNTOfficiel_1_2_22->installOverrides())) {
        return false;
    }
